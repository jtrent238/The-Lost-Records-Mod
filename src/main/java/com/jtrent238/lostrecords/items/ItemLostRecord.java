package com.jtrent238.lostrecords.items;
...
public class ItemLostRecord extends ItemRecord
{
 ...
 public ItemLostRecord(String recordName)
 {
 super(recordName);
 ...
 {
 itemIcon = iconRegister.registerIcon("lostrecords:" + "record_" + recordName);
 }
 ...
 {
 return new ResourceLocation("lostrecords:" + name);
 }
}
